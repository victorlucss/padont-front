#!/usr/bin/env node
/**
 * Simple Next.js server with y-websocket collaboration
 * Persistence will be added via Convex later
 */
...
app.prepare().then(() => {
  ...
  wss.on('connection', (ws, req, docName) => {
    ...
    // Let y-websocket handle everything
  ...
  server.listen(port, hostname, () => {
    ...
    console.log(`⚠️  No persistence - data lost on restart`);
  });
});
